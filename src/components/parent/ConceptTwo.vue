<template>
  <v-container>
    <section-title>教育・研究サービス</section-title>
    <h2 class="subtitle pb-3">
      Vキリロムグループの資産をフル活用し、実開発・研究開発を通したグローバルIT人材の育成環境を提供します。
    </h2>
    <p class="text">
      多くの日本企業では、海外事業の拡大、国内外拠点のシナジー強化、最新テクノロジーの活用を背景に、グローバルな視点でのITソリューションが求められています。海外への事業拡大に伴う必要性に加えて、M&Aやテクノロジーの進化に伴って海外と英語でコミュニケーションをする必要性が増えていることでしょう。
      <br />
      Vキリロムジャパンは、グローバルな開発リソースだけでなく、御社スタッフが自ら成長する環境を合わせて提供します。実務に繋がらない研修・育成プログラムを今すぐやめて、キリロムにお越しください。実案件をグローバルな環境で成し遂げる力、新しい知識・素晴らしい経験が得られ、御社の成長に貢献できます。
    </p>
    <card-left-right
