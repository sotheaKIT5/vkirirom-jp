<template>
  <v-container>
    ...
    <p class="text">
      A2Aデジタルジャパンは、日本企業が第4次産業革命にキャッチアップし、グローバルな市場で成長していくための戦略を共に実行する組織として設立されました。様々な業界を破壊するテクノロジーの登場により世界は混乱しています。A2Aデジタルジャパンの人的・技術的サービスを活用することで経営課題を解決しましょう。
    </p>
    <card-left-right
