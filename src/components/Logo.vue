  ...
  <router-link to="/" class="logo d-flex align-center">
    ...
    >
      <path
        ...
        d="M0.2,74L22.9,6.9h18.4L64,74H46.6l-4.2-13.7H21.3L17.2,74H0.2z M38.7,48.2l-6.9-22.1L25,48.2H38.7z"
      />
      <path
        :style="`fill:${color_one}`"
        d="M119.8,74H70.5V63.1c4.2-3.3,7.9-6.4,11.2-9.4c3.3-2.9,6.2-5.7,8.8-8.4c3.3-3.4,5.7-6.5,7.1-9.1
      ...
      <path
        :style="`fill:${color_one}`"
        d="M122.2,74l22.7-67.1h18.4L186,74h-17.3l-4.2-13.7h-21.1L139.2,74H122.2z M160.7,48.2l-6.9-22.1L147,48.2
			H160.7z"
      />
      <path
        :style="`fill:${color_two}`"
        d="M305,16.2h-16.7V3.9H305V16.2z M304.5,74h-15.8V23.4h15.8V74z"
      />
      <path
        :style="`fill:${color_two}`"
        d="M362.7,68.3c0,4.7-0.7,8.7-2,11.9c-1.3,3.3-3.2,5.8-5.5,7.7c-2.4,1.8-5.1,3.2-8.4,4.1
      ...
      <path
        :style="`fill:${color_two}`"
        d="M390.9,16.2h-16.7V3.9h16.7V16.2z M390.5,74h-15.8V23.4h15.8V74z"
      />
      <path
        :style="`fill:${color_two}`"
        d="M422,75.1c-6.4,0-11.1-1.3-14-3.9c-2.9-2.7-4.4-7-4.4-13V34.5h-6v-11h6V9h15.8v14.5h15.2v11h-15.2v17.9
      ...
      <path
        :style="`fill:${color_two}`"
        d="M468.9,68.7c-1.1,0.9-2,1.7-2.9,2.4c-0.8,0.7-2,1.5-3.4,2.2s-2.8,1.2-4.1,1.6c-1.3,0.4-3.2,0.6-5.6,0.6
      ...
      />
      <path :style="`fill:${color_two}`" d="M512,74h-15.8V3.9H512V74z" />
      <g>
        <path
          :style="`fill:${color_two}`"
          d="M275.8,23.6c-2.5-4.8-6-8.6-10.5-11.4c-3.6-2.3-7.5-3.7-11.6-4.4c-4.1-0.6-8.5-0.9-13.3-0.9h-3.9v5.8h-6.9
